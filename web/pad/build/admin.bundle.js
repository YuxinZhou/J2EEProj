	...
	$(document).ready(function () {
	    $('#admin').bootstrapValidator({
	        onSuccess: function onSuccess() {
	            ...
	            var scoreMin = Number($('#scoreMin').val().trim());
	            var scoreMax = Number($('#scoreMax').val().trim());
	            var scoreDifference = Number($('#scoreDifference').val().trim());
	    ...
	    var examData = window.localStorage.exam ? JSON.parse(window.localStorage.exam) : null;
